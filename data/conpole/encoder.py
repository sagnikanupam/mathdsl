"""
conpole: encoder.py | Author : Sagnik Anupam

Same format as encoder.py in compositional_graphics/Re2, but for the math domain with conpole primitives.
"""
...
class ConpoleFeatureExamplesEncoder(ModelLoader):
    """
