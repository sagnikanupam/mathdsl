"""
lemma: grammar.py | Author : Sagnik Anupam
...
import dreamcoder.domains.lemma.lemmaMathPrimitives as mathPrimitives
...
class LemmaGrammarLoader(ModelLoader):
    """Loads the math grammar with lemma abstractions.
    """

    name = "lemma"  # Special handler for OCaml enumeration.
