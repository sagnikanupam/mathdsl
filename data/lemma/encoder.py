"""
lemma: encoder.py | Author : Sagnik Anupam

Same format as encoder.py in compositional_graphics/Re2, but for the math domain with Lemma's abstractions.
"""
...
class MathFeatureExamplesEncoder(ModelLoader):
    """
    Loads the Re2 Feature Extractor class for applications in the math domain with lemma abstractions. Note that this does not return an initialized model. It returns the class that can be instantiated from the experiment state, with other params set.
    """
